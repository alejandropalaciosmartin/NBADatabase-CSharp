...
public partial class Index
{
    ...
    {
        players = await Http.GetFromJsonAsync<List<PlayersName>>("./assets/datas.json");
        //CREAMOS NUEVA VARIABLE para reiniciar los datos antes de la búsqueda
        players2 = new List<PlayersName>(players); 
    ...
    public class PlayersName
    {
        ...
        public string DaImagenGeneral(string buscaBandera)
        {
            ...
            string[] imagenExiste = { "CHI", "BOS", "BKN", "NYK", "PHI", "TOR", "CLE", "DET", "IND", "MIL", "DEN", "MIN", "OKC", "POR", "UTA", "GSW", "LAC", "LAL", "PHX", "SAC", "ATL", "CHA", "DAL", "MIA", "MEM", "WAS", "SAS", "NOP", "HOU", "ORL",
                "USA","Bahamas","Canada","Croatia","DemocraticRepublicoftheCongo","France","Germany","Greece","Lithuania","Mali","PuertoRico","Senegal","Serbia","Slovenia","Turkey","Brazil", "Latvia","Australia","Italy","Sweden","Ukraine","Austria",
                "Egypt", "Spain","DominicanRepublic","Cameroon","NewZealand","SouthSudan", "CzechRepublic","Russia","Poland","Argentina","UnitedKingdom","Haiti" ,"China","BosniaandHerzegovina","Georgia", "Switzerland"};

            try
            {
                //Recorremos el array de los paises y equipos que existenten en nuestra grafica
                for (int i = 0; i < imagenExiste.Length; i++)
                {
                    ...
                    {
                        imagen = $"./assets/imagenes/paisesEquipos/{buscaBandera}.png";
                    }
                    else
                    {
                       switch (buscaBandera)
                        {
                            case "Bosnia and Herzegovina": imagen = $"./assets/imagenes/paisesEquipos/BosniaandHerzegovina.png"; break;
                            case "Czech Republic": imagen = $"./assets/imagenes/paisesEquipos/CzechRepublic.png"; break;
                            case "Democratic Republic of the Congo": imagen = $"./assets/imagenes/paisesEquipos/DemocraticRepublicoftheCongo.png"; break;
                            case "Dominican Republic": imagen = $"./assets/imagenes/paisesEquipos/DominicanRepublic.png"; break;
                            case "New Zealand": imagen = $"./assets/imagenes/paisesEquipos/NewZealand.png"; break;
                            case "Puerto Rico": imagen = $"./assets/imagenes/paisesEquipos/PuertoRico.png"; break;
                            case "South Sudan": imagen = $"./assets/imagenes/paisesEquipos/SouthSudan.png"; break;
                            case "United Kingdom": imagen = $"./assets/imagenes/paisesEquipos/UnitedKingdom.png"; break;
                        }
                        imagen = $"./assets/imagenes/mundo.png";
                    }
                }
            }
            catch (Exception ex)
